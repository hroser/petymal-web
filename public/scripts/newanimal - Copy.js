...
friendlyPix.NewAnimal = class {
  ...
  constructor() {
    ...
    $(document).ready(() => {
      // DOM Elements
      this.addNewAnimal = $('#addNewAnimalButton');
	  this.addImageButton = $('#newAnimalImageButton');
      this.imageInput = $('#fp-newAnimalMediacapture');
      this.overlay = $('.fp-overlay', '#page-new-animal');
      this.newPictureContainer = $('#newAnimalPictureContainer');
      this.uploadButton = $('.fp-upload');
      this.newAnimalName = $('#newAnimalName');
	  this.newAnimalParentFemale = $('#newAnimalParentFemale');
	  this.newAnimalParentMale = $('#newAnimalParentMale');
      this.uploadPicForm = $('#newAnimalForm');
      this.toast = $('.mdl-js-snackbar');
	  this.showNewAnimalParentFemale = $('#show-newAnimalParentFemale');
	  this.showNewAnimalParentMale = $('#show-newAnimalParentMale');
	  this.inputNewAnimalParentFemale = $('#input-newAnimalParentFemale');
	  this.inputNewAnimalParentMale = $('#input-newAnimalParentMale');

      // Event bindings
      this.addNewAnimal.click(() => this.initiateAddPage());
      ...
      this.newAnimalName.keyup(() => this.uploadButton.prop('disabled', !this.newAnimalName.val()));
    });
  }
  ...
  disableUploadUi(disabled) {
    ...
    this.newAnimalName.prop('disabled', disabled);
  ...
  clear() {
    ...
    friendlyPix.MaterialUtils.clearTextField(this.newAnimalName[0]);
      ...
      for (i = 0; i < arr.length; i++) {
        ...
        if (arr[i].substr(0, val.length).toUpperCase() == val.toUpperCase()) {
          ...
          /*execute a function when someone clicks on the item value (DIV element):*/
			  ...
			  if (inp.id == "newAnimalParentFemale") {
				  console.log("inp.id");
					console.log(inp.id);
				  this.showNewAnimalParentFemale.innerHTML = "testfemale";
			  }
...
friendlyPix.newAnimal = new friendlyPix.NewAnimal();
