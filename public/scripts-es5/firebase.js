...
friendlyPix.Firebase = function () {_createClass(_class, null, [{ key: 'POSTS_PAGE_SIZE',
  ...
  /**
    ...
    uri, callback) {var _this = this;var latestEntryId = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;var fetchPostDetails = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
    ...
    uri, pageSize) {var _this2 = this;var earliestEntryId = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;var fetchPostDetails = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
    ...
    pic, thumb, fileName, text) {var _this5 = this;
      ...
      var picRef = this.storage.ref(this.auth.currentUser.uid + '/full/' + newPostKey + '/' + fileName);
      var metadata = {
      ...
      var thumbRef = this.storage.ref(this.auth.currentUser.uid + '/thumb/' + newPostKey + '/' + fileName);
    ...
    postId, callback) {
      var thumbRef = this.database.ref('/posts/' + postId + '/thumb_url');
